Attribute VB_Name = "Mem_modSysMem"
Option Explicit
...
Dim message As FormattedString

    Set message = New FormattedString
    With message
        .columnWidths = Array(colwidth, colwidth, colwidth, colwidth)
        .indents = 1
...
Dim message As FormattedString
    ...
    Set message = New FormattedString
    With message
        .setColWidths colwidth, colwidth, colwidth, colwidth
        .setIndents 1, 2, 1
        Debug.Print .Format("col1", "col2", "col3", "col4")
    End With
